...
export function Section({
...
}) {
  {
    return (
      <Card>
        <div className="flex items-start md:items-center justify-between border-b border-border px-4 pb-6 md:pb-6 md:px-8 lg:pb-8">
...
export function InfoGrid({ children }: { children: React.ReactNode }) {
  return (
    <div className="px-4 md:px-8 grid grid-cols-2 gap-x-16 gap-y-6">
      {children}
    </div>
  );
}
