...
export default async function StoreVendorsPage({
  ...
  const storeStatus = clsx(
    'rounded-full font-medium px-1.5 py-0.5 text-[0.65rem] capitalize',
    {
    ...
    <main>
      <div className="space-y-12">
        <div className="space-y-4">
          <h2 className="text-2xl font-semibold capitalize">{storeName}</h2>
          <p className="text-sm text-neutral-500">
            Browse products in {storeName}
          </p>
        </div>

        {/* Vendor */}
        <Card className="bg-foreground-200 flex items-start sm:items-center justify-between">
          <div className="lg:flex items-start flex-1 gap-6 space-y-6 lg:space-y-0 mb-0">
            <div>
              <Image
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center  gap-8">
                ...
                <p className="text-xs text-neutral-500 flex gap-4">
                ...
                <p className=" text-xs text-neutral-500 flex gap-1 items-center space-x-2">
                  {store?.storeSubcategories?.length !== 0 &&
                    store.storeSubcategories?.map(
